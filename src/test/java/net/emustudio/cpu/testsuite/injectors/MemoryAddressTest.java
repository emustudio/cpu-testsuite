...
public class MemoryAddressTest {
    ...
    public void testByteConstructor() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>((byte) 0x42);
        assertNotNull(injector);
    }

    @Test
    public void testIntegerConstructor() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>(0x1234);
        assertNotNull(injector);
    }

    @Test
    public void testAcceptByteValue() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>((byte) 0x55);
    ...
    public void testByteValueOnlyWritesOneByte() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>((byte) 0x99);
    ...
    public void testWordValueWritesTwoBytes() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>(0xABCD);
    ...
    public void testByteValueTruncation() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>((byte) 0xFF);
        injector.accept(cpuRunner, 0x100);
    ...
    public void testWordValueTruncation() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>(0x12345);
        injector.accept(cpuRunner, 0x100);
    ...
    public void testAcceptAtDifferentAddresses() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>((byte) 0x77);
    ...
    public void testAcceptWithZeroByteValue() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>((byte) 0);
        injector.accept(cpuRunner, 0x100);
    ...
    public void testAcceptWithZeroWordValue() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>(0);
        injector.accept(cpuRunner, 0x100);
    ...
    public void testAcceptWithMaxWordValue() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>(0xFFFF);
        injector.accept(cpuRunner, 0x100);
    ...
    public void testAcceptWithByteOperandType() {
        MemoryAddress<TestCpuRunner, Byte> injector = new MemoryAddress<>((byte) 0x88);
    ...
    public void testAcceptWithShortOperandType() {
        MemoryAddress<TestCpuRunner, Short> injector = new MemoryAddress<>(0xABCD);
    ...
    public void testAcceptOverwritesMemory() {
        MemoryAddress<TestCpuRunner, Integer> injector1 = new MemoryAddress<>((byte) 0x11);
        MemoryAddress<TestCpuRunner, Integer> injector2 = new MemoryAddress<>((byte) 0x22);
    ...
    public void testNegativeByteValue() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>((byte) -1);
        injector.accept(cpuRunner, 0x100);
    ...
    public void testNegativeWordValue() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>(-1);
        injector.accept(cpuRunner, 0x100);
    ...
    public void testWordValueWithHighBitSet() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>(0x8000);
        injector.accept(cpuRunner, 0x100);
    ...
    public void testByteValueWithHighBitSet() {
        MemoryAddress<TestCpuRunner, Integer> injector = new MemoryAddress<>((byte) 0x80);
        injector.accept(cpuRunner, 0x100);
